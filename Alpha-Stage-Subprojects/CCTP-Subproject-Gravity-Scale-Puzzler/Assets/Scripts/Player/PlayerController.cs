...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip ("How close should collisions be to player.")]
    ...
    // Wall-Walk Variables
    [HideInInspector] public bool wallWalk;
    [HideInInspector] public float gravityRotationSpeed = 10.0f;
    [HideInInspector] public float wallWalkDetection = 1.5f;
    ...
    Vector3 SurfaceAngle()
    {
        ...
        // Front raycast
        RaycastHit rayFront;
        Physics.Raycast (playerChild.transform.position, playerChild.transform.forward, out rayFront, wallWalkDetection);
        ...
        // Down raycast
        RaycastHit rayDown;
        Physics.Raycast (playerChild.transform.position, -playerChild.transform.up, out rayDown, wallWalkDetection);
        ...
        // Back raycast
        RaycastHit rayBack;
        Physics.Raycast (playerChild.transform.position, -playerChild.transform.forward, out rayBack, wallWalkDetection);

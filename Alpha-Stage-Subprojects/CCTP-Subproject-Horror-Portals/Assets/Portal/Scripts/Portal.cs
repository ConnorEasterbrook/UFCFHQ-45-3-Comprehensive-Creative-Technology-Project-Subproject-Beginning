...
public class Portal : MonoBehaviour
{
	...
	void PortalMovement()
	{
		for (int i = 0; i < portalObjects.Count; i++)
		{
            ...
            // Transform portalObjectTransform = portalObject.transform;
			...
			Vector3 pos = portalPair.transform.TransformPoint (relativePos); // Establish world space transform for portal object now that halfturn is applied
			...
			Quaternion rot = portalPair.transform.rotation * relativeRot; // Establish rotation variable for correct way to face after teleportation
			...
			{
				portalObject.Teleport (transform, portalPair.transform, pos, rot); // Teleport the portal object
